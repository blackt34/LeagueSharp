...
namespace AutoJungle.Data
{
    internal class ItemHandler
    {
        ...
        {
            ItemList.Add(new BuyingOrder(1, 2031, "Refillable Potion", 150)); //藥水
            ItemList.Add(new BuyingOrder(2, 3340, "Trinket", 0)); //飾品眼
            ItemList.Add(new BuyingOrder(3, (int)ItemId.Vampiric_Scepter, "Vampiric_Screpter", 900)); //吸血鬼權杖
            ItemList.Add(new BuyingOrder(4, (int)ItemId.Boots_of_Speed, "Boots of Speed", 300)); //速度之靴
            ItemList.Add(new BuyingOrder(5, (int)ItemId.Boots_of_Swiftness, "Boots of Swoftness", 500)); //輕靈之靴
            ItemList.Add(new BuyingOrder(6, (int)ItemId.Bilgewater_Cutlass, "Bilgewater Cutlass", 1650)); //吸血彎刀
            ItemList.Add(new BuyingOrder(7, (int)ItemId.Blade_of_the_Ruined_King, "BOTRK", 1750)); //殞落王者之劍
            ItemList.Add(new BuyingOrder(8, (int)ItemId.Recurve_Bow, "Recurve Bow", 1000)); //反曲弓
            ItemList.Add(new BuyingOrder(9, (int)ItemId.Wits_End, "Wits End", 1800)); //智慧末刃 
            ItemList.Add(new BuyingOrder(10, (int)ItemId.Tiamat_Melee_Only, "Tiamat", 1250)); //海神之斧 
            ItemList.Add(new BuyingOrder(11, (int)ItemId.Ravenous_Hydra_Melee_Only, "Ravenous Hydra Melee Only", 1450)); //狂怒九頭蛇 
            ItemList.Add(new BuyingOrder(12, (int)ItemId.Zeal, "Zeal", 1200)); //狂熱雙刀 
            ItemList.Add(new BuyingOrder(13, (int)ItemId.Phantom_Dancer, "Phantom Dancer", 1500)); //幻影之舞
        }
