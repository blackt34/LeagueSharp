...
namespace Mastery_Badge_Spammer
{
    public static class Program
    {
        ...
        public static void OnGameLoad(EventArgs args)
        {
            ...
            Menu.AddItem(new MenuItem("mode", "Mode").SetValue(new StringList(new[] {"MASTERY", "LAUGH", "DANCE", "JOKE", "TAUNT", "DISABLED"})));
            Menu.AddItem(
        ...
        private static void OnUpdate(EventArgs args)
        {
			...
			if (Menu.Item("emotehotkey").GetValue<KeyBind>().Active)
            {
                DoEmote();
                return;
            }
        ...
        {
            var eminsec = Menu.Item("eminsec").GetValue<Slider>().Value;
			var emaxsec = Menu.Item("emaxsec").GetValue<Slider>().Value;
			if (Utils.GameTimeTickCount - LastEmoteSpam > Random.Next(eminsec, emaxsec))
            {
